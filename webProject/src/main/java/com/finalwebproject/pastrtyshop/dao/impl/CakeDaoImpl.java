...
public class CakeDaoImpl implements CakeDao {
    ...
    @Override
    public int createWithId(Cake cake) {
        int lastId = 0;
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
    ...
    @Override
    public List<Cake> findById(int id) {
        List<Cake> cakes = new ArrayList<>();
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
    ...
    @Override
    public List<Cake> findByCost(double cost) {
        List<Cake> cakes = new ArrayList<>();
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
    ...
    @Override
    public List<Cake> findByStuffing(Stuffing stuffing) {
        List<Cake> cakes = new ArrayList<>();
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
    ...
    private List<Cake> createCakeList(ResultSet resultSet){
        List<Cake> cakes = new ArrayList<>();
    ...
    @Override
    public boolean updateCost(double cost, int cakeId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updateWeight(double weight, int cakeId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updateStuffing(Stuffing stuffing, int cakeId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updateDesignDescription(String description, int cakeId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
