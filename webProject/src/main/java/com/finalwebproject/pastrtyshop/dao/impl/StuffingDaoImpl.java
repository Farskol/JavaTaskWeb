...
public class StuffingDaoImpl implements StuffingDao {
    ...
    @Override
    public boolean delete(Stuffing stuffing) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
    ...
    @Override
    public boolean create(Stuffing stuffing) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public List<Stuffing> findById(int stuffingId) {
        List<Stuffing> stuffings = new ArrayList<>();
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
    ...
    @Override
    public List<Stuffing> findByStuffing(String stuffing) {
        List<Stuffing> stuffings = new ArrayList<>();
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
    ...
    private List<Stuffing> createStuffingsList(ResultSet resultSet){
        List<Stuffing> stuffings = new ArrayList<>();
    ...
    @Override
    public boolean updateStuffing(String stuffing, int stuffingId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updateDescription(String description, int stuffingId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
