...
public class DessertDaoImpl implements DessertDao {
    ...
    @Override
    public boolean delete(Dessert dessert) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
    ...
    @Override
    public boolean create(Dessert dessert) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try {
    ...
    @Override
    public List<Dessert> findById(int dessertId) {
        List<Dessert> desserts = new ArrayList<>();
    ...
    @Override
    public List<Dessert> findByCost(double cost) {
        List<Dessert> desserts = new ArrayList<>();
    ...
    private List<Dessert> createDessertList(ResultSet resultSet){
        List<Dessert> desserts = new ArrayList<>();
    ...
    @Override
    public boolean updateCost(double cost, int dessertId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try {
    ...
    @Override
    public boolean updateDescription(String description, int dessertId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try {
    ...
    @Override
    public boolean updateName(String name, int dessertId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try {
    ...
    @Override
    public boolean updateType(String type, int dessertId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try {
