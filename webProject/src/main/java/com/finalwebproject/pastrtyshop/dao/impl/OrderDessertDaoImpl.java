...
public class OrderDessertDaoImpl implements OrderDessertDao {
    ...
    @Override
    public List<OrderDessert> findAll() {
    ...
    @Override
    public boolean delete(OrderDessert orderDessert) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
    ...
    @Override
    public boolean create(OrderDessert orderDessert) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
    ...
    @Override
    public List<OrderDessert> findById(int orderDessertId) {
        List<OrderDessert> orderDesserts = new ArrayList<>();
    ...
    @Override
    public List<OrderDessert> findByCount(int count) {
        List<OrderDessert> orderDesserts = new ArrayList<>();
    ...
    @Override
    public List<OrderDessert> findByOrder(Order order) {
        List<OrderDessert> orderDesserts = new ArrayList<>();
    ...
    @Override
    public List<OrderDessert> findByCake(Cake cake) {
        List<OrderDessert> orderDesserts = new ArrayList<>();
    ...
    @Override
    public List<OrderDessert> findByDessert(Dessert dessert) {
        List<OrderDessert> orderDesserts = new ArrayList<>();
    ...
    private List<OrderDessert> createOrderDessertsList(ResultSet resultSet){
        List<OrderDessert> orderDesserts = new ArrayList<>();
    ...
    @Override
    public boolean updateCount(int count, int orderDessertId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
    ...
    @Override
    public boolean updateOrder(Order order, int orderDessertId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
    ...
    @Override
    public boolean updateCake(Cake cake, int orderDessertId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
    ...
    @Override
    public boolean updateDessert(Dessert dessert, int orderDessertId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
