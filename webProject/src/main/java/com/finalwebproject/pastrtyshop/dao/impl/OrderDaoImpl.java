...
public class OrderDaoImpl implements OrderDao {
    ...
    @Override
    public List<Order> findByInWhatDate(Date inWhatDate) {
        List<Order> orders = new ArrayList<>();
    ...
    @Override
    public List<Order> findBySecondName(String secondName) {
        List<Order> orders = new ArrayList<>();
    ...
    private List<Order> createOrderList(ResultSet resultSet){
        List<Order> orders = new ArrayList<>();
        try {
    ...
    @Override
    public boolean updateOrderDate(Date orderDate, int orderId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updateTotalPrice(double totalPrice, int orderId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updateClient(Client client, int orderId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updateOrderStatus(OrderStatus orderStatus, int orderId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updateInWhatDate(Date inWhatDate, int orderId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updateFirstName(String firstName, int orderId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updateSecondName(String secondName, int orderId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updatePhoneNumber(String phoneNumber, int orderId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
