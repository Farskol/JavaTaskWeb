...
public class ClientDaoImpl implements ClientDao {
    ...
    private List<Client> createClientList(ResultSet resultSet){
        List<Client> clients = new ArrayList<>();
        try {
    ...
    @Override
    public boolean updateLogin(String login, int clientId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updatePassword(String password, int clientId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updateFirstName(String firstName, int clientId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updateSecondName(String secondName, int clientId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updateEmail(String email, int clientId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updatePhoneNumber(String phoneNumber, int clientId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updateRole(ClientRole role, int clientId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updateStatus(ClientStatus status, int clientId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
    ...
    @Override
    public boolean updateDiscount(ClientDiscount discount, int clientId) {
        CustomConnectionPool connectionPool = CustomConnectionPool.getInstance();
        Connection connection = connectionPool.getConnection();
        PreparedStatement statement = null;
        try{
